class ItemsController < ApplicationController
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:price, :name, :tag_list, :category, :sub_category, :store, :category_attributes => [:name], :sub_category_attributes => [:name], :store_attributes => [:name])
    end
end
